 ...
 * @returns colom land
 */
export const ColumnsLand: (props: PropsColomnInterface) => ColomnInterface[] = ({ hndelUpdate }) => [
    {
        name: 'No',
 ...
 * @returns colom air
 */
export const ColumnsAir: (props: PropsColomnInterface) => ColomnInterface[] = ({ hndelUpdate }) => [
    {
        name: 'No',
        cell: (row: any) => <span style={{ width: '10px' }}>{row?.no + 1 ?? 0}</span>,
        width: '10px',
