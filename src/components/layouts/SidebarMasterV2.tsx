...
import { MdDashboardCustomize, MdFolder } from 'react-icons/md'
...
export const SidebarMasterV2: React.FC = () => {
                ...
                <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
                    <div style={{ flex: 1, marginBottom: '32px' }}>
                        ...
                        <Menu menuItemStyles={menuItemStyles}>
                            <SubMenu label="Dashboard" icon={<MdDashboardCustomize />}>
                                <MenuItem>Dashboard</MenuItem>
                            </SubMenu>
                            <MenuItem icon={<MdFolder />} href={`/master/mcity`} className={act === 'vendors' ? classsAct : ''}>
                                City
                            </MenuItem>
                            <MenuItem icon={<MdFolder />} href="/master/mrute">
                                Rute
                            </MenuItem>
                        </Menu>
                    </div>
