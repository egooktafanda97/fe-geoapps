...
const AirFreight: React.FC = () => {
    ...
    const [btnLoads, setBtnLoads] = useState<Boolean>(false)
    ...
    return (
        <Layout isAuth={true} header="Biaya Land Freight">
                ...
                <div className="row row-cols-3">
                    <div className="col-12 sm:col-12 md:col-12 xl:col-9">
                        <CardBox classname="w-100">
                            ...
                            <Tables auth={true} refresh={tbRefresh} url={`${api}/generate/air`} onRowClick={onClickTable} columns={colomDock} />
                        </CardBox>
                    </div>
                    ...
                    >
                        ...
                        <div className="flex justify-center items-center mb-5">
                            ...
                            >
                                {global?.loading ? (
                                    <>
                                        <LoadingButton loading={global?.loading}>
                                            <b>Eksekusi</b>
                                        </LoadingButton>
                                    </>
                                ) : (
