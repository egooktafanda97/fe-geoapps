                    ...
                    <div className="row row-cols-3">
                        <div className="col-12 sm:col-12 md:col-12 xl:col-9">
                            <CardBox classname="w-100">
                                ...
                                <Tables auth={true} refresh={tbRefresh} url={`${api}/generate/land`} onRowClick={onClickTable} columns={colomDock} />
                            </CardBox>
                        </div>
                        <div className="col-12 sm:col-12 md:col-12 xl:col-3">
                            <CardInfo isDetail={isDetail} />
                            <ButtonLoading
