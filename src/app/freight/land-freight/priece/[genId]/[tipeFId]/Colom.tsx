...
import { ColomnInterface, PropsColomnInterface } from '@/utils/_interface/DatatableInterface'
 ...
 * @returns colom land
 */
export const ColumnsLand: (props: PropsColomnInterface) => ColomnInterface[] = ({ hndelUpdate }: PropsColomnInterface) => [
    {
        name: 'No',
 ...
 * @returns colom air
 */
export const ColumnsAir: (props: PropsColomnInterface) => ColomnInterface[] = ({ hndelUpdate }: PropsColomnInterface) => [
    {
        name: 'No',
        cell: (row: any) => <span style={{ width: '10px' }}>{row?.no + 1 ?? 0}</span>,
        width: '10px',
    ...
    {
        name: 'Handling Fee',
        cell: (row: any) => rupiah(`${row?.handling_fee}`) ?? '',
        sortable: true,
    },
    {
        name: 'Biaya Admin',
 ...
 * @returns colom air
 */
export const ColumnsSea: (props: PropsColomnInterface) => ColomnInterface[] = ({ hndelUpdate }: PropsColomnInterface) => [
    {
        name: 'No',
        cell: (row: any) => <span style={{ width: '10px' }}>{row?.no + 1 ?? 0}</span>,
        width: '10px',
    ...
    },
    {
        ...
        cell: (row: any) => rupiah(row?.tralling_origin ?? ''),
        sortable: true,
    },
    {
        name: '@Container',
