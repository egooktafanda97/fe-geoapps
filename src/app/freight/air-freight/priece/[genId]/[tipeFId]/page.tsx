...
interface interfacePrieceVendor {
    params: { genId: string; tipeFId: string }
}
const PrieceVendor: React.FC<interfacePrieceVendor> = ({ params }: interfacePrieceVendor): React.JSX.Element => {
    ...
    return (
        <Layout isAuth={true} header="DAFTAR HARGA VENDOR UDARA">
            <>
