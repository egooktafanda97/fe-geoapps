 ...
 * @returns colom land
 */
export const ColumnsLand: any = ({ hndelUpdate }: any) => [
    {
        name: 'No',
 ...
 * @returns colom air
 */
export const ColumnsAir: any = ({ hndelUpdate }: any) => [
    {
        name: 'No',
        cell: (row: any) => <span style={{ width: '10px' }}>{row?.no + 1 ?? 0}</span>,
        width: '10px',
 ...
 * @returns colom air
 */
export const ColumnsSea: any = ({ hndelUpdate }: any) => [
    {
        name: 'No',
        cell: (row: any) => <span style={{ width: '10px' }}>{row?.no + 1 ?? 0}</span>,
        width: '10px',
    ...
    {
        name: 'Tipe',
        cell: (row: any) => row?.modaType?.moda_types_name ?? '',
        sortable: true,
    },
    {
        name: 'Service',
